        ...
        <div class="row">
            <div class="col-md-8">
                <form id="customForm" method="POST" action="">
                    ...
                    <button type="submit" name="submit" class="btn submit-btn btn-block">Submit Trip</button>
                </form>
            </div>
            <div class="col-md-4">
                <h2>total</h2>
                <div id="displayValue" class="display-value">Price: $0</div>
            </div>
        </div>
    </div>
    <script>
        $(document).ready(function() {
            ...
            $('#service_level').on('change', function() {
                ...
                $('#displayValue').text('Selected Price: $' + (selectedValue ? selectedValue.charAt(0).toUpperCase() + selectedValue.slice(1) : 'None'));
            });
        });
    </script>
</body>
